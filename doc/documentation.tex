...
\begin{document}
	...
	vyskytujú rôzne údaje. Údaje boli získané z nasledovných stránok a nie sú úplne presné,
	avšak pre vytvorenie si predstavy o probléme s plastovým odpadom sú dostačujúce.
	Údaje boli získané z nasledovných stránok.
	...
	kategória C 75\%, kategória D 16\% a kategória E 3,6\%.
