...
\begin{document}
	...
	nárast oproti roku 2017. Tento údaj bol zjednodušený a v simulačnom modeli sa
	generuje každý deň 1 milión ton plastu čo je vo výsledku 365 miliónov ton
	plastu ročne. Priestupné roky zanedbávame pretože pri takomto množstve je tento
	...
	Podľa grafov vyskytujúcich sa na portále \textbf{European Parliamentary Research Service Blog} \cite{plastic_graph}
	...
	alebo iné jednorázové produkty z plastu. Takisto sú tu spomenuté množstvá jednotlivých
	...
	Nasledovne boli predmety zoskupené do kategórií podľa doby rozkladu. Výsledky sú v tabuľke.

	\begin{table}[]
	\begin{tabular}{llllll}
	\textbf{}                                                                          & \textbf{MNOŽSTVO} & \textbf{\begin{tabular}[c]{@{}l@{}}KUSOVÁ\\ HMOTNOSŤ\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}CELKOVÁ\\ HMOTNOSŤ\end{tabular}} & \textbf{\begin{tabular}[c]{@{}l@{}}DOBA\\ ROZKLADU\end{tabular}} & \textbf{KATEGÓRIA} \\
	\textbf{\begin{tabular}[c]{@{}l@{}}cigaretový ohorok/\\ drobný odpad\end{tabular}} & 2412151           & 1,4 g                                                              & 3377 kg                                                             & 10-12 rokov                                                      & A                  \\
	\textbf{PET fľaša}                                                                 & 1569135           & 30 g                                                               & 47074 kg                                                            & 450 rokov                                                        & \multirow{3}{*}{B} \\
	\textbf{PET vrchnák}                                                               & 1091107           & 2 g                                                                & 2182 kg                                                             & 450 rokov                                                        &                    \\
	\textbf{slamka}                                                                    & 643562            & 0,42 g                                                             & 270 kg                                                              & 450 rokov                                                        &                    \\
	\textbf{igelitová taška}                                                           & 757523            & 5,5 g                                                              & 4166 kg                                                             & 200-1000 rokov                                                   & \multirow{3}{*}{C} \\
	\textbf{plastové vrece}                                                            & 746211            & 5,5 g                                                              & 4104 kg                                                             & 200-1000 rokov                                                   &                    \\
	\textbf{fólia/drobný obal}                                                         & 1739743           & 2 g                                                                & 3479 kg                                                             & 200-1000 rokov                                                   &                    \\
	\textbf{\begin{tabular}[c]{@{}l@{}}"take away"\\ box z peny\end{tabular}}          & 580570            & 4,5 g                                                              & 2612 kg                                                             & 50-80 rokov                                                      & \multirow{3}{*}{D} \\
	\textbf{\begin{tabular}[c]{@{}l@{}}"take away"\\ box z platu\end{tabular}}         & 632874            & 4,5 g                                                              & 2848 kg                                                             & 50-80 rokov                                                      &                    \\
	\textbf{\begin{tabular}[c]{@{}l@{}}plastový kelímok/\\ vrchnák\end{tabular}}       & 624878            & 3 g                                                                & 1874 kg                                                             & 50-80 rokov                                                      &                    \\
	\multicolumn{3}{r}{{\ul SPOLU}}                                                                                                                                             & \multicolumn{3}{l}{{\ul 71986 kg}}
	\end{tabular}
	\caption{Tabuľka top 10 nájdených predmetov a výsledkov meraní}
	\label{tab:1}
	\end{table}

	Nakoniec bola vypočítaná percentuálna zastúpenosť jednotlivých skupín v
	celkovom množstve vyzbieraného odpadu. Skupina A má zasúpenie 5\%, skupina B 69\%,
	skupina C 16\% skupina D 10\%.
